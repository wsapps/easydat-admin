...
public class BaseController {
	 ...
	 * 返回成功
	 */
	protected Result<Object> succeed() {
	 ...
	 * 返回成功消息
	 */
	protected Result<String> succeed(String message) {
	 ...
	 * 返回失败消息
	 */
	protected Result<String> failure(String message) {
	 ...
	 * @return 操作结果
	 */
	protected Result<Object> toAjax(int rows) {
	 ...
	 * @return 操作结果
	 */
	protected Result<Object> toAjax(boolean result) {
