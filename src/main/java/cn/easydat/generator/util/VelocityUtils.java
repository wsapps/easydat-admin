package cn.easydat.generator.util;
...
public class VelocityUtils {
	...
	public static String getDicts(GenTable genTable) {
		...
		return CollectionUtil.join(dicts, ", ");
	}
	...
	public static void addDicts(Set<String> dicts, List<GenTableColumn> columns) {
		for (GenTableColumn column : columns) {
			if (!column.isSuperColumn() && StrUtil.isNotEmpty(column.getDictType())
					&& StrUtil.equalsAny(column.getHtmlType(), new String[] { GenConstants.HTML_SELECT, GenConstants.HTML_RADIO, GenConstants.HTML_CHECKBOX })) {
	...
	public static String getParentMenuId(JSONObject paramsObj) {
		if (!paramsObj.isEmpty() && paramsObj.containsKey(GenConstants.PARENT_MENU_ID) && StrUtil.isNotEmpty(paramsObj.getStr(GenConstants.PARENT_MENU_ID))) {
